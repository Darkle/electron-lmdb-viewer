...
var _hoisted_5$6 = /* @__PURE__ */ createBaseVNode("span", {
  id: "change-page-hint",
  style: { "display": "none" }
...
var _sfc_main$5 = {
  ...
  methods: {
    ...
    changePage(pageNumber, emit2 = true) {
      if (pageNumber > 0 && this.total > this.currentPerPage * (pageNumber - 1)) {
        this.prevPage = this.currentPage;
        this.currentPage = pageNumber;
        this.pageChanged(emit2);
      }
    },
    nextPage() {
...
var _hoisted_7$4 = { class: "footer__navigation vgt-pull-right" };
...
var _hoisted_4$4 = /* @__PURE__ */ createBaseVNode("span", {
  "aria-hidden": "true",
  class: "input__icon"
}, [
  /* @__PURE__ */ createBaseVNode("div", { class: "magnifying-glass" })
], -1);
var _hoisted_5$4 = /* @__PURE__ */ createBaseVNode("span", { class: "sr-only" }, "Search", -1);
var _hoisted_6$4 = [
  _hoisted_4$4,
  _hoisted_5$4
];
var _hoisted_7$3 = ["id", "placeholder", "value"];
...
var _hoisted_5$3 = ["name", "placeholder", "value", "onKeyup", "onInput"];
var _hoisted_6$3 = ["name", "value", "onChange"];
var _hoisted_7$2 = {
  value: "",
  key: "-1"
};
var _hoisted_8$2 = ["value"];
var _hoisted_9$2 = ["name", "value", "onChange"];
var _hoisted_10$2 = {
  value: "",
  key: "-1"
};
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return $options.hasFilterRow ? (openBlock(), createElementBlock("tr", _hoisted_1$3, [
    $props.lineNumbers ? (openBlock(), createElementBlock("th", _hoisted_2$3)) : createCommentVNode("v-if", true),
          ...
          renderSlot(_ctx.$slots, "column-filter", {
            ...
            $options.isFilterable(column) ? (openBlock(), createElementBlock("div", _hoisted_4$3, [
              ...
              $options.isDropdownArray(column) ? (openBlock(), createElementBlock("select", {
                ...
                createBaseVNode("option", _hoisted_7$2, toDisplayString($options.getPlaceholder(column)), 1),
              ...
              $options.isDropdownObjects(column) ? (openBlock(), createElementBlock("select", {
                ...
                createBaseVNode("option", _hoisted_10$2, toDisplayString($options.getPlaceholder(column)), 1),
                (openBlock(true), createElementBlock(Fragment, null, renderList(column.filterOptions.filterDropdownItems, (option, i) => {
                  return openBlock(), createElementBlock("option", {
                    key: i,
                    value: option.value
...
var _hoisted_4$2 = ["title", "aria-sort", "aria-controls"];
var _hoisted_5$2 = ["onClick"];
var _hoisted_6$2 = { class: "sr-only" };
        ...
        return openBlock(), createElementBlock(Fragment, { key: index2 }, [
          !column.hidden ? (openBlock(), createElementBlock("th", {
            ...
            $options.isSortableColumn(column) ? (openBlock(), createElementBlock("button", {
              ...
              createBaseVNode("span", _hoisted_6$2, " Sort table by " + toDisplayString(column.label) + " in " + toDisplayString($options.getColumnSortLong(column)) + " order ", 1)
  ...
  methods: {
    ...
    filterRows(columnFilters, fromFilter = true) {
      ...
      if (instancesOfFiltering) {
        this.filteredRows = computedRows.filter((h2) => h2.children && h2.children.length);
      } else {
        this.filteredRows = computedRows;
      }
    },
...
var _hoisted_2 = /* @__PURE__ */ createBaseVNode("span", { class: "vgt-loading__content" }, " Loading... ", -1);
...
var _hoisted_16 = /* @__PURE__ */ createBaseVNode("div", { class: "vgt-center-align vgt-text-disabled" }, " No data for table ", -1);
var _hoisted_17 = {
  key: 2,
...
createApp(MainComponent).use(index).mount("#container");
/*!
